    ...
    <div className="pt-16 sm:pt-20">
      ...
      <section className="border-b border-earth-200/60 bg-cream-100">
        <div className="container-px grid grid-cols-2 gap-px overflow-hidden md:grid-cols-4">
          {[
            ...
            <Reveal key={v.title} staggerIndex={i} staggerMs={60} className="flex items-center gap-3 bg-cream-100 px-4 py-5">
      ...
      <section className="container-px py-16 sm:py-20">
        ...
        <div className="mt-8 grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4">
          {featured.map((p, i) => (
            <Reveal key={p.id} staggerIndex={i} staggerMs={100} direction="up">
        ...
        <div className="container-px grid items-center gap-10 lg:grid-cols-2">
          <Reveal direction="left">
            ...
            <ul className="mt-6 space-y-3 text-sm text-cream-200/90">
              {['Adjustable heat levels', 'Extra ingredients with live pricing', 'Sizes from 250g to 5kg', 'Saved as unique cart items'].map((f, i) => (
                <li key={f} className="flex items-center gap-3" style={{ animationDelay: `${i * 80}ms` }}>
      ...
      <section className="container-px py-16 sm:py-20">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          {topExperiences.map((exp, i) => (
            <Reveal key={exp.id} staggerIndex={i} staggerMs={120} direction="up">
              <button
                onClick={() => navigate(`/experience/${exp.id}`)}
                className="group relative w-full overflow-hidden rounded-3xl text-left shadow-card transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lift"
              >
                <img src={exp.images[0]} alt={exp.name} className="aspect-[4/5] w-full object-cover transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-110" />
      ...
      <section className="bg-cream-100 py-16 sm:py-20">
        <div className="container-px grid items-center gap-10 lg:grid-cols-2">
          <Reveal direction="scale" className="relative order-2 lg:order-1">
        ...
        <div className="container-px">
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <Reveal key={f.title} staggerIndex={i} staggerMs={80} className="card p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lift">
