...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="container-px flex h-16 items-center justify-between gap-4 sm:h-20">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <ShoppingBag size={18} />
            {count > 0 && (
              <span className="absolute -right-1 -top-1 flex h-5 min-w-5 items-center justify-center rounded-full bg-spice-600 px-1 text-[10px] font-bold text-cream-50 animate-scale-in">
                {count}
              </span>
            )}
          </button>
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div className="animate-fade-in border-t border-earth-200/70 bg-cream-50 lg:hidden">
